...
#define TTY0_TX_PIN           7
#define TTY0_RX_PIN           6
#define TTY0_LOCATION     USART_ROUTE_LOCATION_LOC2
...
#define TTY1_PORT         PORTB
#define TTY1_TX_PIN          13
#define TTY1_RX_PIN          14
#define TTY1_LOCATION     LEUART_ROUTE_LOCATION_LOC1
