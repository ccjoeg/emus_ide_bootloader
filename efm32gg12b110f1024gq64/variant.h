...
#define TTY0_LOCATION_EN  (LEUART_ROUTEPEN_RXPEN | LEUART_ROUTEPEN_TXPEN)
...
#define TTY0_CLK_REG      LFBCLKEN0
#define TTY0_CLKEN        CMU_LFBCLKEN_LEUART0
#define TTY0_PORT         PORTF
//Pin49
#define TTY0_TX_PIN          0 
//Pin50
#define TTY0_RX_PIN          1
#define TTY0_LOCATION_EN  (LEUART_ROUTEPEN_RXPEN | LEUART_ROUTEPEN_TXPEN)
#define TTY0_LOCATION_RX     LEUART_ROUTELOC0_RXLOC_LOC3
#define TTY0_LOCATION_TX    LEUART_ROUTELOC0_TXLOC_LOC3
#define TTY0_CKDIV_REG    LEUART_CLKDIV_REG
...
#define TTY1_LOCATION_EN  (LEUART_ROUTEPEN_RXPEN | LEUART_ROUTEPEN_TXPEN)
#define TTY1_LOCATION_RX     LEUART_ROUTELOC0_RXLOC_LOC0
#define TTY1_LOCATION_TX    LEUART_ROUTELOC0_TXLOC_LOC0
#define TTY1_CKDIV_REG    LEUART_CLKDIV_REG
#define TTY1_CLKDIV       EFMGG_LEUART_CLKDIV
...
__STATIC_INLINE void CONFIG_UsartSetup(void)
{
  ...
  TTY0[ROUTEEN_REG]  = TTY0_LOCATION_EN;
  TTY0[ROUTELOC_REG] = TTY0_LOCATION_RX
                                | TTY0_LOCATION_TX;
  ...
  TTY1[ROUTEEN_REG]  = TTY1_LOCATION_EN;
  TTY1[ROUTELOC_REG] = TTY1_LOCATION_RX
                                | TTY1_LOCATION_TX;
